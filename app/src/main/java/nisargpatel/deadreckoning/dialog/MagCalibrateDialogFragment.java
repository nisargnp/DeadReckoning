...
public class MagCalibrateDialogFragment extends DialogFragment implements SensorEventListener{
    ...
    private static final String[] DATA_FILE_NAMES = {"Magnetic-Field-Uncalibrated"};
    ...
    public void onStart() {
        ...
        buttonNeutral.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRunning) {
                    dataFileWriter.writeToFile("Magnetic-Field-Uncalibrated", "Calculated biases: " + Arrays.toString(magneticFieldBias.getBias()));
                    dismissDialog();
                } else {
                    sensorManager.registerListener(MagCalibrateDialogFragment.this, sensorMagneticField, SensorManager.SENSOR_DELAY_FASTEST);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED) {
            magneticFieldBias.calcBias(new float[] {event.values[0], event.values[1], event.values[2]});
